  ...
  methods: {
    ...
    getSearch: function(search) {
      ...
      Promise.all(
        ...
        .then(resp => {
          // CREATE ARRAY FOR MOVIES IF ALL OR MOVIE CATEGORY IS ACTIVE
          if (this.sectionActive === 'movie' || this.sectionActive === 'all') {
            ...
            ResultsMovie.forEach(e => {
              ...
              // IF GENRE IS 'tutti' PUSH ALL NEW OBJECT
              ...
              // IF GENRE IS SELECTED PUSH ONLY THE OBJECTS THAT HAVE THE SELECTED GENRE
              } else {
          ...
          // CREATE ARRAY FOR TV IF ALL OR MOVIE CATEGORY IS ACTIVE
          ...
          // ASSOCIATE GENRE AND CAST TO MOVIE OBJECTS
          if (this.sectionActive === 'movie' || this.sectionActive === 'all') {
          ...
          // ASSOCIATE GENRE AND CAST TO TV OBJECTS
          if (this.sectionActive === 'tv' || this.sectionActive === 'all') {
